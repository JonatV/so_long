...
"./textures/ground.xpm", &game->mlx.size, &game->mlx.size);
	game->mlx.sprite_wall = mlx_xpm_file_to_image(game->mlx.mlx, \
"./textures/wall.xpm", &game->mlx.size, &game->mlx.size);
